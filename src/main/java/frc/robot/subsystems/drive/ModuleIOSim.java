// ============================================================================
//  ModuleIOSim.java = the SIMULATION version of a module's IO.
//    Instead of real motors it runs a small physics model, so the whole robot can be
//    driven on a laptop with no hardware at all. Great for learning and testing.
